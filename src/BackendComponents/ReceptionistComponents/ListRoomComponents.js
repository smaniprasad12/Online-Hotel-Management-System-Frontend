...
const RListRoomComponents = () => {
    ...
    return (
        ...
        <div className = "container">
            ...
            <Link to = "/Radd-room" className = "btn btn-primary mb-2" > Add Room </Link>
                ...
                <tbody>
                    {
                            ...
                            <tr key = {room.id}> 
                                ...
                                <td>{room.checkOut}</td>
                                  ...
                                  <td>
                                    <Link className="btn btn-info" to={`/Rupdateroom/${room.id}`} >Update</Link>
...
export default RListRoomComponents
...
export const RAddReservationComponents = () => {
    ...
    const saveOrUpdateReservation = (e) => {
        ...
        if (id) {
            ReservationService.updateReservationbyId(id, reservation).then((response) => {
                history.push('/RListReservationComponent')
            }).catch(error => {
                console.log(error)
            })
                    ...
                    <div className="card col-md-6 offset-md-3 offset-md-3">
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit}>
                                ...
                                <Link to="/RListReservationComponent" className="btn btn-danger"> Cancel </Link>
                            </form>
...
export default RAddReservationComponents

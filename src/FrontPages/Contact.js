...
function Contact() {
  ...
  const submitInfo = (event) => {
    ...
    emailjs.send('service_vdo5t88','template_dgbjprn', emailContent, 'b7CdY6RpCj1XlZyqk')
    .then((result) => {
  ...
  const validate = (emailContent) => {
    ...
    else if (!name_regex.test(emailContent.to_name)) {
      errors.to_name = "Not valid UserName!";
    }
  ...
  return (
    ...
    <div className="container border"
      style={{
        marginTop: "50px",
        width: "100%",
        backgroundImage: `url('https://www.mycustomer.com/sites/default/files/email_marketing.jpg')`,

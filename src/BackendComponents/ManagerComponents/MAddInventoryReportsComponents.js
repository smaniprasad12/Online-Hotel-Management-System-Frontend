    ...
    const saveOrUpdateInventoryReports = (e) => {
        ...
        if (id) {
            InventoryReportsService.updateInventoryReports(id, inventoryreports).then((response) => {
                history.push('/MListInventoryReportsComponent')
            }).catch(error => {
                console.log(error)
            })
                    ...
                    <div className="card col-md-6 offset-md-3 offset-md-3">
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit} >
                                ...
                                <Link to="/MListInventoryReportsComponent" className="btn btn-danger"> Cancel </Link>
                            </form>
...
export default MAddInventoryReportsComponents
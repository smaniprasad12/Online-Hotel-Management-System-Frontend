...
export const AddRoomComponents = () => {
    ...
    const saveOrUpdateRoom = (e) => {
        ...
        if(id){
            RoomService.updateRoombyId(id, room).then((response) => {
                ...
                history.push('/ListRoomComponent')
            }).catch(error => {
                console.log(error)
            })
    ...
    const validate = (room) => {
        ...
        else if (!name_regex.test(room.roomNo.length > 1)) {
        ...
        // }
        // else if (!name_regex.test(room.checkIn.length > 0)) {
        //     errors.checkIn = "This is not a valid checkIn format!";
        // }
        // if (!room.checkOut) {
        //     errors.checkOut = "CheckOut is required!";
        // }
        // else if (!name_regex.test(room.checkOut.length > 0)) {
        //     errors.checkOut = "This is not a valid CheckOut format!";
        // }
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                           {
                            ...
                            <div className = "card-body">
                                ...
                                <p>{formErrors.checkOut}</p>
                                    ...
                                    <Link to="/ListRoomComponent" className="btn btn-danger"> Cancel </Link>
                                </form>
...
=-0987654E`W`
    ...
    export default AddRoomComponents
